...
then
    ...
    then
        ...
        $MD5SUM $DistPath/"$TargetName".elf $DistPath/"$TargetName".bin $DistPath/"$ImageName"_sign.img $DistPath/"$ImageName"_sign_ota.img
    else
        ...
        $MD5SUM $DistPath/"$TargetName".elf $DistPath/"$TargetName".bin $DistPath/"$ImageName"_sign.img $DistPath/"$ImageName"_sign.fls
    fi
elif [ $zip_type == 1 ]
then
    ...
    $MD5SUM $DistPath/"$TargetName".elf $DistPath/"$TargetName".bin $DistPath/"$ImageName".img $DistPath/"$ImageName"_unsign_ota.img
else
    $WMTOOL -b "$SDKPath"/tools/W806/W806_secboot.bin -o "$SDKPath"/tools/W806/W806_secboot -it 0 -fc 0 -ra $sec_img_pos -ih $sec_img_header -ua $upd_img_pos -nh $run_img_header -un 0  > /dev/null
    ...
    $MD5SUM $DistPath/"$TargetName".elf $DistPath/"$TargetName".bin $DistPath/"$ImageName".img "$SDKPath"/tools/W806/W806_secboot.img $DistPath/"$ImageName"_unsign.fls
fi
